...
export default function AllFormsDashboard({ forms, onDeleteForm }) {
  ...
  return (
    <main className="bs23-forms-dashboard">
      <header className="bs23-forms-dashboard__header">
        <div>
          <span>BS23 Form Builder</span>
          <h1>All Forms</h1>
        </div>
        <a href={adminPageUrl('bs23-form-builder-add-new')}>Add New Form</a>
      </header>
        ...
        {filteredForms.length === 0 ? (
          ...
          <article className="bs23-forms-table__row" key={form.id}>
            ...
            <a className="bs23-forms-table__entries" href={adminPageUrl('bs23-form-builder-entries', { form_id: form.id })}>
              {Number(form.entries_count || 0).toLocaleString()}
            </a>
